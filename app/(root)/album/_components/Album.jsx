            ...
            {data.image ? (
                <div>
                    ...
                    <div className="mt-5 mb-1">
                        ...
                        <p className="text-sm text-muted-foreground">by <span className="text-primary">{data.artists.primary.map(artist => artist.name).join(",")}</span></p>
                    </div>
                    <Badge>
                ...
                <>
                    ...
                    <Skeleton className="h-3 mt-4 w-32"/>
                    <Skeleton className="h-3 mt-2 mb-3 w-40"/>
                    <Skeleton className="h-3 mt-1 mb-8 w-14"/>
                    <ScrollArea className="rounded-md mt-4">
