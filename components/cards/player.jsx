...
export default function Player() {
    ...
    return (
        <main>
            ...
            {values.music && <div className="shadow-lg dark:shadow-none fixed flex items-center bottom-0 m-[10px] rounded-md right-0 w-full border-t left-0 z-50 bg-background p-3 md:px-20 lg:px-32 gap-4">
